...
export const DONATE_URL = 'https://saweria.co/elrayyxml'; // Lia@Note 02-02-26 --- Apologies if this feels cheeky, just a fallback
export const LIBRARY_NAME = '@nexray - ElrayyXml';
